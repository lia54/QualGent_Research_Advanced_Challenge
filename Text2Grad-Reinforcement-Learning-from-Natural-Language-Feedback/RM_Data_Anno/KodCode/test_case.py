...
if __name__ == "__main__":
    ...
    # Select examples from incorrect split based on target counts for each difficulty
    target_counts = {
    ...
    # Combine train and incorrect samples
    balanced_dataset = list(train_samples) + incorrect_balanced_dataset
    
    # Now run tests on the balanced dataset
    print("\nRunning tests on balanced dataset...")
    processed_dataset = []
    error_types = {}  # For tracking error types
    ...
    # Print detailed test results statistics
    ...
    # Print passing examples by difficulty
