...
"""Gemini Prompt: Gemini Prompting Autonomous Agent for Android."""
import sys
import os
...
from gemini_prompting import generate_prompt_from_screenshot
import subprocess
...
ACTION_SELECTION_PROMPT_TEMPLATE = (
    PROMPT_PREFIX
    + '\nHere is a Gemini generated instructions based on a screenshot{generated_prompt}'
...
def _action_selection_prompt(
  ...
  take_screenshot(output_file="example_screenshot_4.png") # Taking the current screenshot
  example_image_path_4 = "example_screenshot_4.png"
  example_task_id_4 = "task_click_gmail_001" # Added task_id
  example_task_goal_4 = goal
  ...
  generated_prompt_1 = generate_prompt_from_screenshot(
        image_path=example_image_path_4,
        task_id=example_task_id_4, # Pass task_id
        task_goal=example_task_goal_4,
        description_prompt=specific_description_prompt
    )
  print(generated_prompt_1)
  return ACTION_SELECTION_PROMPT_TEMPLATE.format(
      generated_prompt=generated_prompt_1,
      history=history,
      goal=goal,
