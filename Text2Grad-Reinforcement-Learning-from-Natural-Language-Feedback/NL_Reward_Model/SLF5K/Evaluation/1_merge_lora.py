...
def parse_args():
    ...
    parser.add_argument("--lora_model", type=str, default="../ckpt/llama31-8B-span-v2-nofeedback/0_4000",
                        help="Path to the LoRA model")
    parser.add_argument("--save_dir", type=str, default="../ckpt/llama31-8B-span-v2-nofeedback/0_4000_merge",
