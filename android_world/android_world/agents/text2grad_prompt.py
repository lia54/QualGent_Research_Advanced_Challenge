...
class Text2gradPrompt(base_agent.EnvironmentInteractingAgent):
  ...
  def step(self, goal: str, prompt: str) -> base_agent.AgentInteractionResult:
    step_data = {
