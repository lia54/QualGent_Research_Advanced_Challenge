...
# ===== Model Configuration =====
# Reward model path
REWARD_MODEL_NAME="/cosmos/hanyang_critic/RLAIF/ppo_token/rm_train/QA_FS_RM_KODCODE/ckpt/llama31-8B-span2span-v2/0_4000_merge"
...
# ===== Training Parameters =====
# Output and logging
OUTPUT_DIR="ckpt/llama3.2-3B-kodcode"
