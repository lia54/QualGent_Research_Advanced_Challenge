...
def parse_args():
    ...
    parser.add_argument("--lora_model", type=str, 
                        default="/cosmos/hanyang_critic/RLAIF/ppo_token/rm_train/QA_FS_RM_Ultrafeedback/ckpt/llama31-8B-span2span-v2-nofeedback/0_10000", 
                        help="Path to LoRA model")
    parser.add_argument("--save_dir", type=str, 
                        default="/cosmos/hanyang_critic/RLAIF/ppo_token/rm_train/QA_FS_RM_Ultrafeedback/ckpt/llama31-8B-span2span-v2-nofeedback/0_10000_merge", 
